...
The above functions can already allow us to handle some basic tasks with strings. However, if we really want to unleash the power of strings manipulation, we need to leanr _regular exoressions_ (aka **regex**). 
...
| [[:xdigit:]] | Hexadecimaldigits: 0-9 A B C D E F a b c d e f                                      |
